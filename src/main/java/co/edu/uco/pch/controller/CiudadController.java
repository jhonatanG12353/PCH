...
public final class CiudadController {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<CiudadResponse> crear(@PathVariable UUID id){
		var httpStatusCode = HttpStatus.ACCEPTED;
		var ciudadResponse = new CiudadResponse();
	...
	@PutMapping ("/{id}")
	public ResponseEntity<CiudadResponse> crear(@PathVariable UUID id, @RequestBody CiudadDTO ciudad){
		var httpStatusCode = HttpStatus.ACCEPTED;
		var ciudadResponse = new CiudadResponse();
